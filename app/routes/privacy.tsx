  ...
  return (
    <InfoLayout imageStr={imageStr} title="Privacy Policy">
      <div className="flex justify-center items-center p-4">
        <div className="bg-white py-10 max-w-[673px]">
            ...
            <div>
              ...
              <ul className="list-disc pl-8 mb-4">
                <li>
                  ...
                  us. This may include passwords, usernames, mailing addresses,
                  email addresses, phone numbers, names, billing addresses,
                  contact preferences, and blood group.
                </li>
                <li>
                  Sensitive information, such as health data, which we may
                  process when necessary with your consent or as otherwise
                ...
                <li>
                  Social Media Login Data, if you choose to register with us
              ...
              <ul className="list-disc pl-8 mb-4">
                ...
                <li>
                  To protect our Website and comply with legal obligations.
                </li>
              </ul>
              <h2 className="text-2xl font-bold mb-4">
              ...
              <p className="mb-4">
                You have the right to review, change, or terminate your account
                at any time. You can also withdraw your consent to the
              ...
              <p className="mb-4">
                ...
                access to, change, or delete the personal information we collect
                from you. To do so, please submit a data subject access request.
              </p>
            </div>
          </div>
        </div>
