          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg p-8">
            ...
            <div>
              ...
              <ul className="list-disc pl-8 mb-4">
                ...
                <li>
                  Return Timeline: Products must be returned within 2-3 days
              ...
              <ul className="list-disc pl-8 mb-4">
                ...
                <li>
                  ...
                  or call us at +91-9945011116. Our team will review your
                  request and guide you through the process.
                </li>
                <li>
                  <strong>Refund Timeline:</strong> Refunds are processed within
                  7-10 business days after the returned product has been
                  received and inspected.
                </li>
                <li>
                  <strong>Defective Products:</strong> If you&#39;ve received a
                  defective item and prefer a refund, please email clear images
                  to
                  <a
                    href="mailto:sales@offroadacademies.com"
                    className="text-blue-500"
              ...
              <ul className="list-disc pl-8 mb-4">
                <li>
                  <strong>Cancellation Eligibility:</strong> Course
                  cancellations are accepted only if requested before 48 hours
                ...
                <li>
                  ...
                  or call us at +91-9945011116 . Our team will assist you with
                ...
                <li>
                  ...
                  once a course has begun, even if only partially attended.
                  Please ensure the course schedule aligns with your
                  availability before enrolling.
                </li>
                <li>
                  <strong>Non-Refundable Fees:</strong> Any administrative or
                  registration fees associated with the course are
                  non-refundable.
                </li>
              </ul>
            </div>
